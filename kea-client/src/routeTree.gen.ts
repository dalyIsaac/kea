...
const ProviderOwnerRepoPullPrIdImport = createFileRoute(
...
const ProviderOwnerRepoPullPrIdPullRoute =
  ProviderOwnerRepoPullPrIdPullImport.update({
    id: '/_pull',
    getParentRoute: () => ProviderOwnerRepoPullPrIdRoute,
  } as any)

const ProviderOwnerRepoPullPrIdPullIndexRoute =
  ProviderOwnerRepoPullPrIdPullIndexImport.update({
    id: '/',
    path: '/',
    getParentRoute: () => ProviderOwnerRepoPullPrIdPullRoute,
  } as any)

const ProviderOwnerRepoPullPrIdPullReviewRoute =
  ProviderOwnerRepoPullPrIdPullReviewImport.update({
    id: '/review',
    path: '/review',
    getParentRoute: () => ProviderOwnerRepoPullPrIdPullRoute,
  } as any)
...
const ProviderOwnerRepoPullPrIdPullRouteChildren: ProviderOwnerRepoPullPrIdPullRouteChildren =
  {
    ProviderOwnerRepoPullPrIdPullReviewRoute:
      ProviderOwnerRepoPullPrIdPullReviewRoute,
    ProviderOwnerRepoPullPrIdPullIndexRoute:
      ProviderOwnerRepoPullPrIdPullIndexRoute,
  }

const ProviderOwnerRepoPullPrIdPullRouteWithChildren =
  ProviderOwnerRepoPullPrIdPullRoute._addFileChildren(
    ProviderOwnerRepoPullPrIdPullRouteChildren,
  )
...
const ProviderOwnerRepoPullPrIdRouteChildren: ProviderOwnerRepoPullPrIdRouteChildren =
  {
    ProviderOwnerRepoPullPrIdPullRoute:
      ProviderOwnerRepoPullPrIdPullRouteWithChildren,
  }

const ProviderOwnerRepoPullPrIdRouteWithChildren =
  ProviderOwnerRepoPullPrIdRoute._addFileChildren(
