...
import { CommitFile, PullRequestComment, RepoId } from "../../types/kea";
...
export class FileTreeNode implements IParentTreeNode<ReviewCommentTreeNode> {
  ...
  constructor(accountKey: IAccountKey, repoId: RepoId, file: CommitFile, comments: PullRequestComment[]) {
